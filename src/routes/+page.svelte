          ...
          <li>
            ...
            <ul class="menu menu-horizontal bg-base-200 rounded-box">
              <li>
                <button
                  on:click={() => {
                    (toggledElementType = new Ender()), (isWireToggled = false);
                  }}
                >
                  <svg
                    class="h-5 w-5"
              ...
              <li>
                <button
                  on:click={() => {
                    (toggledElementType = new Detector()),
                      (isWireToggled = false);
                  }}
                >
                  <svg
              ...
              <li>
                <button
                  on:click={() => {
                    (toggledElementType = new SternGerlachDevice()),
                      (isWireToggled = false);
                  }}
                >
                  <svg
